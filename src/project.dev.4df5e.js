window.__require = function e(t, n, r) {
  ...
  BallCtrl: [ function(require, module, exports) {
    ...
    var BallCtrl = function(_super) {
      ...
      BallCtrl.prototype.jump = function(direction) {
    ...
    var BossZai = function(_super) {
      ...
      BossZai.prototype.updateWeakness = function(spine) {
        for (var _i = 0, _a = this.weaknessRoot.children; _i < _a.length; _i++) {
          ...
          "bone42" == weak.followBone && (weak.node.active = false);
          weak.spine = spine;
          weak.start();
        }
  ...
  CameraController: [ function(require, module, exports) {
    ...
    var CameraController = function() {
      ...
      CameraController.prototype.zoomIn = function() {
        ...
        this.MainCamera.node.runAction(cc.moveTo(.3, cc.v2(0, 360)));
      };
      CameraController.prototype.zoomOut = function() {
        if (!this.canZoomOut || CAMERA_SHOW_ALL) return;
        this.MainCamera.node.runAction(cc.moveTo(.3, cc.v2(0, 0)));
        this.enableFollow = true;
      };
  ...
  EventName: [ function(require, module, exports) {
    ...
    (function(GlobalEvent) {
      ...
      GlobalEvent[GlobalEvent["PLAYER_ATTACK"] = 3] = "PLAYER_ATTACK";
      ...
      GlobalEvent[GlobalEvent["BALL_USE_DURABLE"] = 9] = "BALL_USE_DURABLE";
    ...
    var Item = function(_super) {
      ...
      Item.prototype.onBeginContact = function(contact, self, other) {
        if (this.itemData) {
          ...
          EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.ITEM_USE, this.itemData.form, callback);
  ...
  MainUI: [ function(require, module, exports) {
    ...
    var MainUI = function(_super) {
      ...
      MainUI.prototype.itemUse = function(type, callback) {
        switch (type) {
         case table_1.Monster_ball_prop_form.HuiFuNaiJiuDu:
      ...
      MainUI.prototype.enableBlock = function(enable) {
        ...
        if (enable) {
          ...
          this.bgBlock.getComponent(cc.Sprite).enabled = true;
          this.bgBlock.getChildByName("SceneDec").active = true;
          this.bgBlock.getChildByName("SceneDec").getComponent(cc.Label).string = "Level: " + Game_1.Game.level.toString();
        } else {
          this.bgBlock.getComponent(cc.BlockInputEvents).enabled = false;
          this.bgBlock.opacity = 255;
          this.bgBlock.getComponent(cc.Sprite).enabled = false;
      ...
      MainUI.prototype.onTouched = function(touch) {
        EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.JUMP, touch.getLocationX() > cc.winSize.width / 2 ? Config_1.JUMP_DIR.RIGHT : Config_1.JUMP_DIR.LEFT);
      };
  ...
  WelcomeScene: [ function(require, module, exports) {
    ...
    (function(LOAD_STEP) {
      ...
      LOAD_STEP[LOAD_STEP["DONE"] = 510] = "DONE";
